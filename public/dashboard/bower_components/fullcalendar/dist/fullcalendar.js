...
function distributeHeight(els, availableHeight, shouldRedistribute) {
    // *FLOORING NOTE*: we floor in certain place because zoom can give inaccurate floating-point dimensions,
...
var HitDragListener = /** @class */ (function (_super) {
    ...
    HitDragListener.prototype.handleScrollEnd = function () {
        ...
        // hits' absolute positions will be in new place after a user's scroll.
...
var DayGrid = /** @class */ (function (_super) {
    ...
    DayGrid.prototype.limitRow = function (row, levelLimit) {
        ...
        var moreWrap;
        var moreLink;
        // Iterates through empty level cells and place "more" links inside if need be
