...
<div class="error">
    ...
    <div class="error__description">man you are so lost</div>
    <a href="{{route('home')}}" class="error__button error__button--active" style="margin-top: 10px; display: inline-block; text-decoration: none;">Go Back To Earth</a>
</div>
